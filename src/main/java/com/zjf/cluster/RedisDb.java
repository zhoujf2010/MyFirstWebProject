...
public class RedisDb
{
    ...
    private static String redisIp = "192.168.201.60";
    ...
    // 初始化连接池
    public static void initPool() throws URISyntaxException {
...
//        jedisPool = new JedisPool(config, redisIp, redisPort, 10000, password);
        ...
        jedisPool = new JedisPool(config, new URI(uri), 1000 * 100);// 超时时间
    }
